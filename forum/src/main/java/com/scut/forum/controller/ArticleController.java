...
public class ArticleController {
    ...
    public SingleResponse<ArticleDto> get(@RequestParam long id) {
        return null;
    }

    @GetMapping("/list/byHot")
    @ApiOperation(value = "/list/byHot", notes = "获取文章列表 （按热度）")
    public MultiResponse<ArticleDto> listByHot(@RequestParam ArticleListParam articleListParam) {
        return null;
    }

    @GetMapping("/list/byTime")
    @ApiOperation(value = "/list/byTime", notes = "获取文章列表 （按时间）")
    public MultiResponse<ArticleDto> listByTime(@RequestParam ArticleListParam articleListParam) {
        return null;
    }

    @GetMapping("/myList")
    @ApiOperation(value = "/myList", notes = "获取我的文章列表")
    public MultiResponse<ArticleDto> myList(@RequestParam ArticleListParam articleListParam) {
        return null;
    }
